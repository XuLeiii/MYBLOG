<template>
  <div>
    <el-button type="primary" size="mini" @click="popdrawer()" class="sub"
      >添加照片</el-button
    >
...
<script>
import { getPhotos, updatePhotos, deletePhoto, addPhoto } from "../api/api.js";
  ...
  methods: {
    ...
    submit(formName) {
      this.$refs[formName].validate(async (valid) => {
        if (valid) {
          //获取input表单中的照片数据的对象，并将其转换为数组形式，方便上传到服务器
